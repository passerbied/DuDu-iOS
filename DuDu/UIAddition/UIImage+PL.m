...
- (UIImage *)imageByCropping:(UIImage *)imageToCrop toRect:(CGRect)rect
{
    ...
    CGContextRef bitmap = CGBitmapContextCreate(NULL,
                                                ...
                                                CGImageGetBitsPerComponent([imageToCrop CGImage]),
                                                0,
                                                CGImageGetColorSpace([imageToCrop CGImage]),
                                                CGImageGetBitmapInfo([imageToCrop CGImage]));
    
    // Rotate and/or flip the image if required by its orientation
    CGContextConcatCTM(bitmap, [self transformForOrientation:imageToCrop.size]);
    CFRelease(bitmap);
